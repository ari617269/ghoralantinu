...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> State Consistency >> TC2: Logout button only visible when authenticated
- Location: tests/e2e/auth-logic.spec.ts:524:5
