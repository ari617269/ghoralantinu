...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> In-Memory Token Storage Logic >> TC3: Token is not in cookies
- Location: tests/e2e/auth-logic.spec.ts:442:5
