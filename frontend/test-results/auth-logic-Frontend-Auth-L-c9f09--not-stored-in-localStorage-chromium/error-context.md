...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> In-Memory Token Storage Logic >> TC1: Token is not stored in localStorage
- Location: tests/e2e/auth-logic.spec.ts:398:5
