...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> In-Memory Token Storage Logic >> TC4: Page refresh clears token (in-memory limitation)
- Location: tests/e2e/auth-logic.spec.ts:457:5
