...
- Name: auth.spec.ts >> Frontend Auth Logic E2E Tests >> Login Logic - Form Submission & State Update >> TC1.1: Valid credentials trigger login API and update Redux state
- Location: tests/e2e/auth.spec.ts:10:5
