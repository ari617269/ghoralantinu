...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> Session Validation Logic >> TC3: Invalid token redirects to login
- Location: tests/e2e/auth-logic.spec.ts:175:5
