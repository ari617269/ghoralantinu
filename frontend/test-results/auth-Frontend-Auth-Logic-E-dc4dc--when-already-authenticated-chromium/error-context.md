...
- Name: auth.spec.ts >> Frontend Auth Logic E2E Tests >> Protected Route Logic - Access Control >> TC2.3: Cannot access login when already authenticated
- Location: tests/e2e/auth.spec.ts:131:5
