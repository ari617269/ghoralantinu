...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> Session Validation Logic >> TC1: Valid token allows home page access
- Location: tests/e2e/auth-logic.spec.ts:144:5
