...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> Protected Route Logic >> TC4: Authenticated user can access home
- Location: tests/e2e/auth-logic.spec.ts:364:5
