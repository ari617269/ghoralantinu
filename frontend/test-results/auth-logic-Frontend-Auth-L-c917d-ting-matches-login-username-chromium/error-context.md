...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> State Consistency >> TC1: Username in greeting matches login username
- Location: tests/e2e/auth-logic.spec.ts:513:5
