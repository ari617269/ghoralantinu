...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> Protected Route Logic >> TC5: Cannot access login when already authenticated
- Location: tests/e2e/auth-logic.spec.ts:376:5
