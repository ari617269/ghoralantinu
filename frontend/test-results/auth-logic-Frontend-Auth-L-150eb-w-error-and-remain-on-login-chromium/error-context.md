...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> Login Logic >> TC2: Invalid credentials show error and remain on login
- Location: tests/e2e/auth-logic.spec.ts:72:5
