...
- Name: auth-logic.spec.ts >> Frontend Auth Logic E2E Tests >> Logout Logic >> TC1: Logout invalidates token and redirects to login
- Location: tests/e2e/auth-logic.spec.ts:218:5
