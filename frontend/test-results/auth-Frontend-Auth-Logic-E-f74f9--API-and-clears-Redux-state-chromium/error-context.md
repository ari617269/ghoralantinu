...
- Name: auth.spec.ts >> Frontend Auth Logic E2E Tests >> Logout Logic - Token Invalidation & State Clearing >> TC3.1: Logout calls API and clears Redux state
- Location: tests/e2e/auth.spec.ts:159:5
